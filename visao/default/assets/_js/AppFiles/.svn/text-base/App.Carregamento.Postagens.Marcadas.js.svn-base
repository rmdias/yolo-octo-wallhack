...
APP.Carregamento.Postagens.Marcadas = {
	_tela: null,
	setUp: function() {
		var that = this;
					...
					postagem += '<section class="conteudo_publicacao">';
	    				...
	    				postagem += '<div class="informacoes_situacao">';
	    					postagem += '<div class="configuracoes">';
	    						postagem += '<div class="publicar botao">';
	    							postagem += '<span class="ico"></span>';
	    							postagem += '<span class="label">Publicar</span>';
	    						postagem += '</div><!-- publicar -->';
