...
APP.Carregamento.Postagens.Pendentes = {
	_tela: null,
	setUp: function() {
		var that = this;
					...
					postagem += '<section class="conteudo_publicacao">';
	    				...
	    				postagem += '<div class="informacoes_situacao">';
	    					postagem += '<div class="configuracoes">';
	    						postagem += '<div class="marcar botao">';
	    							postagem += '<span class="ico"></span>';
	    							postagem += '<span class="label">Marcar</span>';
	    						postagem += '</div><!-- marcar -->';
	    						postagem += '<div class="recusar botao">';
	    							postagem += '<span class="ico"></span>';
	    							postagem += '<span class="label">Recusar</span>';
	    						postagem += '</div><!-- recusar -->';
